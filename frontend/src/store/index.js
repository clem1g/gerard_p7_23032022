...
export default new Vuex.Store({
  ...
  actions: {
    ...
    getUserInfos({ commit, state }) {
      return new Promise((resolve, reject) => {
        instance
          .get(`auth/user/${state.user.userId}`)
          .then(function (response) {
    ...
    editUserName({ state }, newUserName) {
      return new Promise((resolve, reject) => {
        instance
          .put(`auth/user/${state.userInfos.id}`, newUserName)
          .then(function (response) {
            resolve(response);
          })
          .catch(function (error) {
    ...
    deleteUser({ state }) {
      return new Promise((resolve, reject) => {
        instance
          .delete(`auth/user/${state.userInfos.id}`)
          .then(function (response) {
            resolve(response);
          })
          .catch(function (error) {
    ...
    modifyPost({ state }, modifiedPost) {
      return new Promise((resolve, reject) => {
        instance
          .put(`posts/${state.post.id}`, modifiedPost, {
    ...
    deletePost({ state }) {
      ...
      if (state.userInfos.isAdmin) {
        return new Promise((resolve, reject) => {
          instance
            .delete(`posts/admin/${state.post.id}`)
            .then(function (response) {
              resolve(response);
            })
            .catch(function (error) {
        ...
        return new Promise((resolve, reject) => {
          instance
            .delete(`posts/${state.post.id}`, {
              data: { userId: state.post.User.id },
            })
            .then(function (response) {
              resolve(response);
            })
    ...
    editComment({ state }, modifiedComment) {
      return new Promise((resolve, reject) => {
        instance.put(
          `posts/${state.comment.postId}/comments/${state.comment.id}`,
          modifiedComment
        );
        console
    ...
    deleteComment({ state }, { postId, id }) {
      ...
      if (state.userInfos.isAdmin) {
        return new Promise((resolve, reject) => {
          instance
            .delete(`posts/admin/${postId}/comments/${id}`)
            .then(function (response) {
              resolve(response);
            })
            .catch(function (error) {
    ...
    getAllUsersByAdmin({ commit, state }) {
      return new Promise((resolve, reject) => {
        instance
          .get(`auth/admin/users/${state.userInfos.id}`)
          .then(function (response) {
    ...
    editUserRole({ state }, newUserRole) {
      return new Promise((resolve, reject) => {
        instance
          .put(`auth/admin/users/${state.userInfosByAdmin.id}`, newUserRole)
          .then(function (response) {
            resolve(response);
          })
          .catch(function (error) {
    ...
    deleteUserByAdmin({ state }) {
      return new Promise((resolve, reject) => {
        instance
          .delete(`auth/user/${state.userInfosByAdmin.id}`)
          .then(function (response) {
            resolve(response);
          })
          .catch(function (error) {
