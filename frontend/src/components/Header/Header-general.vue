          ...
          <b-navbar-nav class="ml-auto">
            ...
            <li v-if="status != 'login'" class="nav-item">
              <router-link to="/" class="nav-link" exact
                ><b-icon-box-arrow-in-right></b-icon-box-arrow-in-right> Se
            ...
            <li v-if="status == 'login'" class="nav-item">
              <router-link to="/posts" class="nav-link" exact
                ><b-icon-list></b-icon-list> Tous les posts</router-link
              >
            </li>
            <b-nav-item-dropdown v-if="status == 'login' && userName" right>
              ...
              <b-dropdown-item @click="logout()">
                <b-icon-box-arrow-in-left></b-icon-box-arrow-in-left> Se
                déconnecter
              </b-dropdown-item>
            </b-nav-item-dropdown>
          </b-navbar-nav>
