  ...
  <div class="users-posts">
    <div class="user-post" v-for="(post, index) in posts" :key="post.id">
      ...
      <div class="post">
        ...
        <p v-if="post.content" class="post-content">
          {{ contentExcerpt(index) }}
        </p>
        <router-link
      ...
      <div class="comment">
        ...
        >
          <b-button variant="secondary"
            ><b-icon-eye-fill></b-icon-eye-fill> Lire plus</b-button
          >
        </router-link>
        <router-link
          v-if="post.id"
        ...
        >
          <b-button variant="primary"
            ><b-icon-chat-dots-fill></b-icon-chat-dots-fill> Commenter</b-button
          >
        </router-link>
      </div>
    </div>
