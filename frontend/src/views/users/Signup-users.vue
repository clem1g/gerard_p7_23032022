<template>
  <div class="card-groupomania">
    <h1>
      <b-icon-person-plus-fill></b-icon-person-plus-fill> S'inscrire en quelques
      secondes...
    </h1>
    ...
    <b-form @submit.prevent="submitForm" class="form">
      ...
      <b-form-group label="Email" label-for="email">
        ...
        <b-form-invalid-feedback
          >L'email est requis et doit être une adresse
          valide</b-form-invalid-feedback
        >
        <b-form-valid-feedback
          >L'adresse email est valide</b-form-valid-feedback
        >
      </b-form-group>
      ...
      <b-form-group label="Mot de passe" label-for="password">
        ...
        <b-form-invalid-feedback
          >Le mot de passe doit avoir au moins 8 caractères, un nombre, une
          minuscule, et une majuscule</b-form-invalid-feedback
        >
        <b-form-valid-feedback
          >Le mot de passe est valide</b-form-valid-feedback
        >
      </b-form-group>

      <b-alert v-if="status == 'error_create'" variant="danger" show
        ><b-icon-exclamation-triangle></b-icon-exclamation-triangle> Adresse
        email déjà utilisée</b-alert
      >

      <b-button
        type="submit"
        variant="primary"
        :class="{ disabled: invalidateFields }"
